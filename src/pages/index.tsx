...
export default () => {
    return (
        <>
            <Navbar />
            <div className="lg:grid lg:grid-cols-5 bg-primaryBg">
                <div className="space-y-10 lg:col-span-3 mx-10 my-auto py-10">
                    ...
                    <ul className="inline-flex">
                        <li>
                        <button className="py-4 px-10 text-xl text-center font-semibold rounded-full shadow-md text-primaryText border-2 border-alternateText hover:bg-alternateText">
                            My Projects
                        </button>
                        </li>
